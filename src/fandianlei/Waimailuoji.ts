	...
	public static zhujiemianluoji(caiid){
		if(Gameguanli.Kongzhitai().zhujiemiandingbu.parent){
			...
			if(this.di1gekeng == false){
				...
				egret.Tween.get(this.di1gecaiui).to({x:Gameguanli.Kongzhitai().zhujiemiandingbu.width - this.di1gecaiui.width},500).call(()=>{
					if(Gameguanli.Kongzhitai().zhujiemiandingbu.parent){
				...
				egret.Tween.get(this.di2gecaiui).to({x:Gameguanli.Kongzhitai().zhujiemiandingbu.width - this.di2gecaiui.width},500).call(()=>{
					if(Gameguanli.Kongzhitai().zhujiemiandingbu.parent){
				...
				egret.Tween.get(this.di3gecaiui).to({x:Gameguanli.Kongzhitai().zhujiemiandingbu.width - this.di3gecaiui.width},500).call(()=>{
					if(Gameguanli.Kongzhitai().zhujiemiandingbu.parent){
