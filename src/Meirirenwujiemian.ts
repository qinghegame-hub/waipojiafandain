class Meirirenwujiemian extends eui.Component implements  eui.UIComponent {
	public meirirenwudazu:eui.Group;
	public heisebeijingceng:eui.Image;
	public meirirenwuzu:eui.Group;
	public jiemianbeijing:eui.Image;
	public guanbijiemian:eui.Button;
	public meiribiaoti:eui.Label;
	public yitiaoernwu:eui.Group;
	public dantiaobeijingdi:eui.Image;
	public dantiaotushi:eui.Image;
	public renwumingcheng:eui.Label;
	public renwushuoming:eui.Label;
	public lingquanniu:eui.Button;
	public renwujindu:eui.Label;
	public yitiaoernwu0:eui.Group;
	public dantiaobeijingdi0:eui.Image;
	public dantiaotushi0:eui.Image;
	public renwumingcheng0:eui.Label;
	public renwushuoming0:eui.Label;
	public lingquanniu0:eui.Button;
	public renwujindu0:eui.Label;
	public yitiaoernwu1:eui.Group;
	public dantiaobeijingdi1:eui.Image;
	public dantiaotushi1:eui.Image;
	public renwumingcheng1:eui.Label;
	public renwushuoming1:eui.Label;
	public lingquanniu1:eui.Button;
	public renwujindu1:eui.Label;
	public yitiaoernwu2:eui.Group;
	public dantiaobeijingdi2:eui.Image;
	public dantiaotushi2:eui.Image;
	public renwumingcheng2:eui.Label;
	public renwushuoming2:eui.Label;
	public lingquanniu2:eui.Button;
	public renwujindu2:eui.Label;


	public renwubiao:any;//读取任务表
...
//		this.guanbi();
	...
	public guanbi(){
		...
		this.guanbijiemian.addEventListener(egret.TouchEvent.TOUCH_TAP,()=>{
			if(this.parent){
