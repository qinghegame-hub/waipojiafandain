                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml","Zhujiemian":"resource/eui_skins/Zhujiemian.exml","dingbuxinxi":"resource/eui_skins/dingbuxinxi.exml","dibuxinxi":"resource/eui_skins/dibuxinxi.exml","Caipujiemian":"resource/eui_skins/Caipujiemian.exml","Caipucaiping":"resource/eui_skins/Caipucaiping.exml","Caipinjieshaojiemian":"resource/eui_skins/Caipinjieshaojiemian.exml","Guanlijiemian":"resource/eui_skins/Guanlijiemian.exml","Jiajugoumai":"resource/eui_skins/Jiajugoumai.exml","Cuowutishi":"resource/eui_skins/Cuowutishi.exml","Yuangongjiemian":"resource/eui_skins/Yuangongjiemian.exml","Tuiguangchuandan":"resource/eui_skins/Tuiguangchuandan.exml","Tuiguangdianshi":"resource/eui_skins/Tuiguangdianshi.exml","Tuiguangpinglun":"resource/eui_skins/Tuiguangpinglun.exml","Tuiguangdaiyan":"resource/eui_skins/Tuiguangdaiyan.exml","Danjujiemian":"resource/eui_skins/Danjujiemian.exml"};generateEUI.paths['resource/eui_skins/Caipinjieshaojiemian.exml'] = window.CaipinjieshaojiemianSkin = (function (_super) {
	...
	var TuiguangchuandanSkin$Skin42 = 	(function (_super) {
		__extends(TuiguangchuandanSkin$Skin42, _super);
		function TuiguangchuandanSkin$Skin42() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = TuiguangchuandanSkin$Skin42.prototype;
		...
		return TuiguangchuandanSkin$Skin42;
	})(eui.Skin);
	...
	_proto.but_tuiguanganniu_i = function () {
		...
		t.x = 383;
		t.y = 551.35;
		t.skinName = TuiguangchuandanSkin$Skin42;
		return t;
	};
	...
	var TuiguangdaiyanSkin$Skin43 = 	(function (_super) {
		__extends(TuiguangdaiyanSkin$Skin43, _super);
		function TuiguangdaiyanSkin$Skin43() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = TuiguangdaiyanSkin$Skin43.prototype;
		...
		return TuiguangdaiyanSkin$Skin43;
	})(eui.Skin);
	...
	_proto.but_tuiguanganniu0_i = function () {
		...
		t.x = 401.2;
		t.y = 536.16;
		t.skinName = TuiguangdaiyanSkin$Skin43;
		return t;
	};
	...
	var TuiguangdianshiSkin$Skin44 = 	(function (_super) {
		__extends(TuiguangdianshiSkin$Skin44, _super);
		function TuiguangdianshiSkin$Skin44() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = TuiguangdianshiSkin$Skin44.prototype;
		...
		return TuiguangdianshiSkin$Skin44;
	})(eui.Skin);
	...
	_proto.but_tuiguanganniu0_i = function () {
		...
		t.x = 398.99;
		t.y = 560.69;
		t.skinName = TuiguangdianshiSkin$Skin44;
		return t;
	};
	...
	var TuiguangpinglunSkin$Skin45 = 	(function (_super) {
		__extends(TuiguangpinglunSkin$Skin45, _super);
		function TuiguangpinglunSkin$Skin45() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = TuiguangpinglunSkin$Skin45.prototype;
		...
		return TuiguangpinglunSkin$Skin45;
	})(eui.Skin);
	...
	_proto.but_tuiguanganniu1_i = function () {
		...
		t.x = 403;
		t.y = 565.35;
		t.skinName = TuiguangpinglunSkin$Skin45;
		return t;
	};
	...
	var YuangongjiemianSkin$Skin46 = 	(function (_super) {
		__extends(YuangongjiemianSkin$Skin46, _super);
		function YuangongjiemianSkin$Skin46() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = YuangongjiemianSkin$Skin46.prototype;
		...
		return YuangongjiemianSkin$Skin46;
	})(eui.Skin);
	...
	_proto.but_pinyong_i = function () {
		...
		t.x = 349.5;
		t.y = 621;
		t.skinName = YuangongjiemianSkin$Skin46;
		return t;
	};
	...
	var ZhujiemianSkin$Skin48 = 	(function (_super) {
		__extends(ZhujiemianSkin$Skin48, _super);
		function ZhujiemianSkin$Skin48() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ZhujiemianSkin$Skin48.prototype;
	...
	function ZhujiemianSkin() {
		_super.call(this);
		this.skinParts = ["img_fandianyuanhuabg0","img_jiaju_xiaochao","img_jiaju_huoguo","img_jiaju_xiaochi","img_jiaju_dianxin","but_caipu0","but_liuyan0","but_guanli0","but_jingyinbaobiao0","zhongbuzu0","zhuyaozu"];
	...
	_proto.zhuyaozu_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.img_fandianyuanhuabg0_i(),this.img_jiaju_xiaochao_i(),this.img_jiaju_huoguo_i(),this.img_jiaju_xiaochi_i(),this.img_jiaju_dianxin_i(),this.zhongbuzu0_i()];
		return t;
	};
	...
	_proto.but_caipu0_i = function () {
		...
		t.x = 615.5;
		t.y = 243;
		t.skinName = ZhujiemianSkin$Skin48;
		return t;
	};
