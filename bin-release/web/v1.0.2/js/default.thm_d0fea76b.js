                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml","Zhujiemian":"resource/eui_skins/Zhujiemian.exml","dingbuxinxi":"resource/eui_skins/dingbuxinxi.exml","dibuxinxi":"resource/eui_skins/dibuxinxi.exml","Caipujiemian":"resource/eui_skins/Caipujiemian.exml","Caipucaiping":"resource/eui_skins/Caipucaiping.exml","Caipinjieshaojiemian":"resource/eui_skins/Caipinjieshaojiemian.exml","Guanlijiemian":"resource/eui_skins/Guanlijiemian.exml","Jiajugoumai":"resource/eui_skins/Jiajugoumai.exml","Cuowutishi":"resource/eui_skins/Cuowutishi.exml","Yuangongjiemian":"resource/eui_skins/Yuangongjiemian.exml","Tuiguangchuandan":"resource/eui_skins/Tuiguangchuandan.exml","Tuiguangdianshi":"resource/eui_skins/Tuiguangdianshi.exml","Tuiguangpinglun":"resource/eui_skins/Tuiguangpinglun.exml","Tuiguangdaiyan":"resource/eui_skins/Tuiguangdaiyan.exml","Danjujiemian":"resource/eui_skins/Danjujiemian.exml","Ttoudingqipaojiemian":"resource/eui_skins/Ttoudingqipaojiemian.exml","Zhujiemianshangceng":"resource/eui_skins/Zhujiemianshangceng.exml","Toudingwenzi":"resource/eui_skins/Toudingwenzi.exml"};generateEUI.paths['resource/eui_skins/Caipinjieshaojiemian.exml'] = window.CaipinjieshaojiemianSkin = (function (_super) {
	...
	function ZhujiemianSkin() {
		_super.call(this);
		this.skinParts = ["img_fandianyuanhuabg0","img_jiaju_xiaochao","img_jiaju_huoguo","img_jiaju_xiaochi","img_jiaju_dianxin","zhuyaozu"];
	...
	_proto.zhuyaozu_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.img_fandianyuanhuabg0_i(),this.img_jiaju_xiaochao_i(),this.img_jiaju_huoguo_i(),this.img_jiaju_xiaochi_i(),this.img_jiaju_dianxin_i()];
		return t;
	};
	...
	var ZhujiemianshangcengSkin$Skin49 = 	(function (_super) {
		__extends(ZhujiemianshangcengSkin$Skin49, _super);
		function ZhujiemianshangcengSkin$Skin49() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ZhujiemianshangcengSkin$Skin49.prototype;
		...
		return ZhujiemianshangcengSkin$Skin49;
	})(eui.Skin);

	var ZhujiemianshangcengSkin$Skin50 = 	(function (_super) {
		__extends(ZhujiemianshangcengSkin$Skin50, _super);
		function ZhujiemianshangcengSkin$Skin50() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ZhujiemianshangcengSkin$Skin50.prototype;
		...
		return ZhujiemianshangcengSkin$Skin50;
	})(eui.Skin);

	var ZhujiemianshangcengSkin$Skin51 = 	(function (_super) {
		__extends(ZhujiemianshangcengSkin$Skin51, _super);
		function ZhujiemianshangcengSkin$Skin51() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ZhujiemianshangcengSkin$Skin51.prototype;
		...
		return ZhujiemianshangcengSkin$Skin51;
	})(eui.Skin);

	var ZhujiemianshangcengSkin$Skin52 = 	(function (_super) {
		__extends(ZhujiemianshangcengSkin$Skin52, _super);
		function ZhujiemianshangcengSkin$Skin52() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ZhujiemianshangcengSkin$Skin52.prototype;
		...
		return ZhujiemianshangcengSkin$Skin52;
	})(eui.Skin);

	function ZhujiemianshangcengSkin() {
		_super.call(this);
		this.skinParts = ["img_tiziqianduan","but_caipu1","but_liuyan1","but_guanli1","but_jingyinbaobiao1","zhongbuzu1","zhuyaozu"];
	...
	_proto.zhuyaozu_i = function () {
		...
		t.top = 0;
		t.touchThrough = true;
		t.elementsContent = [this.img_tiziqianduan_i(),this.zhongbuzu1_i()];
		return t;
	};
	...
	_proto.but_caipu1_i = function () {
		...
		t.x = 615.5;
		t.y = 243;
		t.skinName = ZhujiemianshangcengSkin$Skin49;
		return t;
	};
	_proto.but_liuyan1_i = function () {
		...
		t.x = 615.5;
		t.y = 121.5;
		t.skinName = ZhujiemianshangcengSkin$Skin50;
		return t;
	};
	_proto.but_guanli1_i = function () {
		...
		t.x = 612.5;
		t.y = 0;
		t.skinName = ZhujiemianshangcengSkin$Skin51;
		return t;
	};
	_proto.but_jingyinbaobiao1_i = function () {
		...
		t.x = 0;
		t.y = 152;
		t.skinName = ZhujiemianshangcengSkin$Skin52;
		return t;
	};
